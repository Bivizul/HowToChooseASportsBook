...
import com.bivizul.howtochooseasportsbook.databinding.FragmentPitfallsBinding
...
class PitfallsFragment : Fragment(R.layout.fragment_pitfalls) {

    @Inject
    lateinit var factory: HowToChooseASBViewModelFactory.Factory

    private val binding by viewBinding(FragmentPitfallsBinding::bind)
