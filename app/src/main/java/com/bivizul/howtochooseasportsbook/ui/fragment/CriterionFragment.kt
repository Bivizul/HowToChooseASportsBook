...
import com.bivizul.howtochooseasportsbook.databinding.FragmentCriterionBinding
...
class CriterionFragment : Fragment(R.layout.fragment_criterion) {

    @Inject
    lateinit var factory: HowToChooseASBViewModelFactory.Factory

    private val binding by viewBinding(FragmentCriterionBinding::bind)
